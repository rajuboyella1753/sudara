          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl overflow-hidden bg-[#0e1638] border border-[#1e2d69] shadow-sm flex items-center justify-center shrink-0">
              {(owner?.image || owner?.hotelImage) ? (
                ...
                <Shirt className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400" />
              )}
            </div>
            ...
            <div className="min-w-0 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                <p className="text-[7px] sm:text-[8px] font-extrabold uppercase text-cyan-400 tracking-widest truncate">క్లాతింగ్ & అప్పారెల్ హబ్</p>
                {daysRemaining > 0 ? (
        ...
        {activeTab === "inventory" && (
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#0a1033] p-5 sm:p-6 rounded-3xl border border-[#1e2d69] shadow-sm">
              <div>
                <h2 className="text-lg sm:text-xl font-black uppercase tracking-tight text-white">అప్పారెల్ ఇన్వెంటరీ కేటలాగ్ / Apparel Catalog</h2>
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-[#0a1033] border border-dashed border-[#1e2d69] rounded-3xl p-12 sm:p-16 text-center space-y-3">
                ...
                <h3 className="text-sm font-black uppercase text-slate-300 tracking-wider">అప్పారెల్ ఏవీ లేవు / No Apparel Found</h3>
                    ...
                    <div>
                      <div className="w-full h-48 sm:h-52 bg-[#05081c] overflow-hidden relative flex items-center justify-center p-4 border-b border-[#1e2d69]">
                        {item.image ? (
                          ...
                          <Shirt className="w-10 h-10 text-slate-600" />
                        )}
          ...
          <div className="fixed inset-0 z-[120] flex items-center justify-center p-3 sm:p-4 bg-[#05081c]/80 backdrop-blur-xs">
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#0a1033] w-full max-w-2xl p-6 sm:p-8 rounded-[2.5rem] shadow-2xl relative border border-[#1e2d69] max-h-[85vh] flex flex-col text-white">
              ...
              <div className="mb-4 pr-8">
                <h3 className="text-lg font-black uppercase text-white tracking-tight">గ్లోబల్ మాస్టర్ అప్పారెల్ కేటలాగ్</h3>
                      ...
                      <div key={mItem._id || mItem.name} className="flex items-center justify-between p-3.5 bg-[#0e1638] rounded-2xl border border-[#1e2d69] hover:border-cyan-400/40 transition-all">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-[9px] font-bold text-cyan-400 bg-cyan-950/40 border border-cyan-500/30 px-2 py-0.5 rounded-md uppercase">{mItem.subCategory || "Men"}</span>
                          </div>
                        </div>
                        <button 
          ...
          <div className="fixed inset-0 z-100 flex items-center justify-center p-3 sm:p-4 bg-[#05081c]/80 backdrop-blur-xs">
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#0a1033] w-full max-w-md p-6 sm:p-8 rounded-3xl shadow-xl relative border border-[#1e2d69] max-h-[90vh] overflow-y-auto text-white">
              ...
              <div className="mb-5 sm:mb-6">
                <h3 className="text-base sm:text-lg font-black uppercase text-white tracking-tight">కొత్త అప్పారెల్ జోడించు / Add Apparel</h3>
              ...
              <form onSubmit={handleAddApparel} className="space-y-4">
                <div>
                  ...
                  <input type="text" required placeholder="e.g. డిజైనర్ సిల్క్ చీర / క్యాజువల్ షర్ట్" value={newApparel.name} onChange={(e)=>setNewApparel({...newApparel, name: e.target.value})} className="w-full bg-[#0e1638] border border-[#1e2d69] px-4 py-3 rounded-xl font-bold text-xs outline-none focus:border-cyan-400 text-white placeholder:text-slate-500" />
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="text-[9px] font-black uppercase text-slate-400 block mb-1">కేటగిరీ / Section</label>
                    <select value={newApparel.subCategory} onChange={(e)=>setNewApparel({...newApparel, subCategory: e.target.value})} className="w-full bg-[#0e1638] border border-[#1e2d69] px-4 py-3 rounded-xl font-bold text-xs outline-none focus:border-cyan-400 cursor-pointer text-white">
                      <option value="Men" className="bg-[#0a1033] text-white">మెన్ / Men</option>
                      <option value="Women" className="bg-[#0a1033] text-white">ఉమెన్ / Women</option>
                      <option value="Kids" className="bg-[#0a1033] text-white">కిడ్స్ / Kids</option>
                      <option value="Ethnic" className="bg-[#0a1033] text-white">ఎథ్నిక్ వేర్ / Ethnic</option>
                  ...
                  <div>
                    ...
                    <input type="number" required placeholder="1499" value={newApparel.price} onChange={(e)=>setNewApparel({...newApparel, price: e.target.value})} className="w-full bg-[#0e1638] border border-[#1e2d69] px-4 py-3 rounded-xl font-bold text-xs outline-none focus:border-cyan-400 text-white placeholder:text-slate-500" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea placeholder="లభించే సైజులు, ఫ్యాబ్రిక్ వివరాలు..." value={newApparel.description} onChange={(e)=>setNewApparel({...newApparel, description: e.target.value})} className="w-full bg-[#0e1638] border border-[#1e2d69] p-4 rounded-xl font-bold text-xs outline-none focus:border-cyan-400 h-20 resize-none text-white placeholder:text-slate-500"></textarea>
                </div>
        ...
        {isEditModal && editingItem && (
          <div className="fixed inset-0 z-100 flex items-center justify-center p-3 sm:p-4 bg-[#05081c]/80 backdrop-blur-xs">
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#0a1033] w-full max-w-md p-6 sm:p-8 rounded-3xl shadow-xl relative border border-[#1e2d69] max-h-[90vh] overflow-y-auto text-white">
              ...
              <div className="mb-5 sm:mb-6">
                <h3 className="text-base sm:text-lg font-black uppercase text-white tracking-tight">అప్పారెల్ సవరించు / Edit Apparel</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select value={editingItem.subCategory} onChange={(e)=>setEditingItem({...editingItem, subCategory: e.target.value})} className="w-full bg-[#0e1638] border border-[#1e2d69] px-4 py-3 rounded-xl font-bold text-xs outline-none focus:border-cyan-400 cursor-pointer text-white">
                      <option value="Men" className="bg-[#0a1033] text-white">మెన్</option>
                      <option value="Women" className="bg-[#0a1033] text-white">ఉమెన్</option>
                      <option value="Kids" className="bg-[#0a1033] text-white">కిడ్స్</option>
                      <option value="Ethnic" className="bg-[#0a1033] text-white">ఎథ్నిక్ వేర్</option>
                      <option value="Accessories" className="bg-[#0a1033] text-white">యాక్ససరీస్</option>
                    </select>
                  </div>
                  <div>
            ...
            >
              <div>
                <div className="flex justify-between items-center mb-8 border-b border-[#131d47] pb-4">
                  <h3 className="text-lg font-black uppercase tracking-wider text-cyan-400 italic">క్లాతింగ్ హబ్ మెనూ / Hub Menu</h3>
