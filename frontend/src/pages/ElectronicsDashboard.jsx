...
const handleAddGadget = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || "గ్యాజెట్ యాడ్ అవ్వడం విఫలమైంది.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const downloadQRCode = async () => {
    try {
      ...
      ctx.fillText("డిజిటల్ స్టాక్ & కోట్ హబ్ / DIGITAL STOCK HUB", canvas.width / 2, 320);
      ...
      qrImg.onload = () => {
        ...
        ctx.fillText("కొనడానికి లేదా కోట్ కోసం స్కాన్ చేయండి", canvas.width / 2, 1260); 
        ...
        const steps = [
            ...
            "2. లైవ్ గ్యాజెట్స్ & కాంపోనెంట్స్ చూడండి",
            "3. నేరుగా కాల్ చేయండి లేదా కోట్ పొందండి"
        ];
  ...
  const handleDeleteProduct = async (id) => {
    if (!window.confirm("ఈ గ్యాజెట్‌ని తొలగించాలనుకుంటున్నారా? / Remove this gadget?")) return;
    try {
                          ...
                          <div class="outer-border">
                            <div class="inner-border">
                              <div class="header">
                                ...
                                <div class="subtitle">Hyperlocal Electronics & Gadgets Ecosystem</div>
                              </div>
                              <div class="cert-label">Certificate of Verification (ధృవీకరణ పత్రం)</div>
                              <div class="present">This establishment is officially recognized as an authorized hyperlocal electronics partner</div>
                              <div class="hub-name">${name}</div>
                              <div class="location">Region: <span>${district} District, ${state}</span></div>
                              <div class="desc">
                                This verification certifies that this electronics hub has successfully integrated into the Sudara Network ecosystem for direct, commission-free neighborhood commerce.
                              </div>
                              <div class="footer">
                                <div class="meta">
