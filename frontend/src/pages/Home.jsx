      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-indigo-300/60 font-bold uppercase tracking-[0.4em] text-[10px] md:text-sm mb-12">College Food Finder & Discovery</p>
          </motion.div>
      ...
      "{searchTerm}" Available Here
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <div className="flex items-center gap-1.5 bg-blue-500/10 px-3 py-1.5 rounded-xl border border-blue-500/20">
                          ...
                          <span className="text-xs font-black text-blue-500">{res.averageRating ? res.averageRating.toFixed(1) : "0.0"}</span>
                        </div>
